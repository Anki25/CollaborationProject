...
app.controller('EventController', [
		...
		function($scope, EventService, $location, $rootScope) {
			...
			self.doAttend=function(id){
				console.log("attending event"+id)
				EventService.doAttend(id);
			}
			
               /*DO NOT ATTEND*/
			
			self.doNotAttend=function(id){
				console.log("not attending event"+id)
				EventService.doNotAttend(id);
			}
